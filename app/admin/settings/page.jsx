...
const settingsSections = [
  ...
  },
  {
    id: "seo",
    title: "SEO Settings",
    description: "Configure search engine optimization and social media meta tags",
    icon: Search,
    fields: [
      {
        name: "metaTitle",
        label: "Meta Title",
        type: "text",
        value: "Cyber Yakku - Premium Gaming Marketplace",
      ...
      },
      {
        ...
        type: "textarea",
        value: "Premium gaming marketplace for all your gaming needs. Discover the latest games, accessories, and more.",
      ...
      },
      {
        ...
        label: "Meta Keywords",
        type: "text",
        value: "gaming, marketplace, games, accessories, cyber yakku",
      ...
      },
      {
        ...
        type: "text",
        value: "",
        placeholder: "Custom OG title (optional, defaults to meta title)",
      },
      {
        name: "ogDescription",
        ...
        type: "textarea",
        value: "",
        placeholder: "Custom OG description (optional, defaults to meta description)",
      },
      {
        ...
        placeholder: "summary, summary_large_image, app, player",
      },
      {
